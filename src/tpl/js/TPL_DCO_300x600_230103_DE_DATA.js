...
(function (egp) {
  ...
  ad.sheetName = 'MC_DELIVERY_CH_DE_DCO_FEED_300X600_2023_1_Sheet1';
  ad.imagesPath = '';
  ...
  ad.initDynamicContent = function () {
    console.log("MC_DELIVERY_CH_DE_DCO_FEED_300X600_02_Sheet1  ID: 10803327");
    console.log("TPL_DCO_AUTO_211101_DE_DATA ad.initDynamicContent", window.EGPlus);
    //+++DE+++
    //OLD->10724036
    Enabler.setProfileId(10803327);
    //Template function
